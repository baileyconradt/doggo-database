...
function addDoggo(name, bio, photo, dob, breed, keywords, callback) {
...
export default function AddDog(props) {
    ...
    return (<>
        ...
        <Modal show={show} onHide={e => setShow(false)}>
            ...
            <Modal.Footer>
                <Button onClick={e => addDoggo(document.getElementById('name').value, document.getElementById('bio').value, document.getElementById('photo').files[0], document.getElementById('dob').value, document.getElementById('breed').value, document.getElementById('keywords').value, () => {
                    //console.log('success!')
                    setShow(false);
                })}>Add Dog</Button>
            </Modal.Footer>
